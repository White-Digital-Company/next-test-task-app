  ...
  return (
    <input
      ...
      className={cn(
        ...
        'aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive text-sm md:text-base border border-[#CCCCCC] bg-white text-black rounded-[8px] placeholder:text-[#666666] p-3 md:p-4 font-(family-name:--font-noto-sans) font-normal',
        className,
      )}
      {...props}
    />
