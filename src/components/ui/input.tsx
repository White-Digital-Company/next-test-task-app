  ...
  return (
    <input
      ...
      className={cn(
        ...
        'aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive text-sm md:text-base border border-grayBorder bg-white text-black rounded-[8px] placeholder:text-grayText p-3 md:p-4 font-noto-sans font-normal',
        className,
      )}
      {...props}
    />
